...
class AuthControllerTest(
    ...
    beforeEach {
        userRepository.save(UserJpaEntity("exists1234", "existPassword"))
        ...
        context("유효하지 않은 요청이 주어졌을 때") {
            ...
            it("회원가입에 실패한다") {
                ...
                httpRequest
                    ...
                    .andExpect(jsonPath("$.data[*].message").value(containsInAnyOrder("아이디는 4자 이상 10자 이하의 알파벳 소문자와 숫자만 허용됩니다.", "비밀번호는 8자 이상 15자 이하의 알파벳 대소문자와 숫자만 허용됩니다.")))
                    .andDo(
                        document(
